 ...
 * Renders form components for framework forms
 */
...
export class FrameworkFormHelpers {
   ...
   */
  static renderExampleFields(framework: Framework): string {
    if (!framework.examples) return '';
   ...
   */
  static renderFormFields(framework: Framework, prepopulateData: Record<string, string> = {}, fromWizard = false): string {
   ...
   */
  static renderSingleField(field: Field, prepopulateData: Record<string, string> = {}, fromWizard = false): string {
   ...
   */
  static renderCriteriaSelector(framework: Framework, subscription: Subscription): string {
   ...
   */
  static renderAdvancedOptions(framework: Framework): string {
   ...
   */
  static renderTemplatesSection(framework: Framework): string {
   ...
   */
  static renderModal(): string {
    return `
      <div id="unified-modal" class="modal">
        <div class="modal-content">
          <button id="unified-modal-close" class="modal-close-btn">&times;</button>
          <div class="modal-icon">
            <i id="unified-modal-icon" class='bx bx-error-circle' style='color:#f39c12; font-size: 3rem;'></i>
          </div>
          <h2 id="unified-modal-title" class="modal-title"></h2>
   ...
   */
  static getInputAttributes(field: Field, value: string): Record<string, any> {
