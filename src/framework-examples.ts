/**
 * Framework example data using builder pattern to eliminate data clumps
 */

import { ExampleBuilder, ExampleData } from './utils/example-builder';

/**
 * Tree-of-Thought framework examples
 */
export const totExamples: ExampleData = ExampleBuilder.buildTotExamples(
  {
...
/**
 * Self-Consistency framework examples
 */
export const selfConsistencyExamples: ExampleData = ExampleBuilder.buildSelfConsistencyExamples(
  {
...
/**
 * Chain-of-Thought framework examples
 */
export const cotExamples: ExampleData = ExampleBuilder.buildCotExamples(
  {
...
/**
 * Role Prompting framework examples  
 */
export const roleExamples: ExampleData = ExampleBuilder.buildRoleExamples(
  {
...
/**
 * Reflection framework examples
 */
export const reflectionExamples: ExampleData = ExampleBuilder.buildReflectionExamples(
  {
